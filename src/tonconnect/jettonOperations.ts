 ...
 */
export const burnJettons = async (jettonAddress: string, amount: string) => {
  ...
  try {
    ...
    error.value = err instanceof Error ? err.message : "Failed to burn Jettons";
    throw err;
  } finally {
 ...
 */
export const transferJettons = async (
  ...
  try {
    ...
    const transferBody = await jettonWallet.createTransferBody(transferParams);
